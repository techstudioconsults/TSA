...
export async function submitLeadForm(data: LeadFormData, marketingCycleId: string) {
  try {
    const response = await fetch(`${BASE_URL}/marketing-cycles/${marketingCycleId}/leads`, {
      method: "POST",
      headers: {
