  ...
  return (
    ...
    >
      <div className="text-center">
        <h2 className="text-2xl font-bold text-white md:text-3xl">{isTimeUp ? timeUpMessage : title}</h2>
        <p className="mt-5 font-medium">
          {isTimeUp ? timeUpSubtitle : `${subtitle} ${formattedDate} or when ${spotsRemaining} spots are filled`}
        </p>
      </div>
        ...
        <div className="mx-auto mt-6 grid w-full max-w-md grid-cols-4 gap-4 text-center">
          {showDays && (
            <div className="flex flex-col items-center rounded-md border-2 border-white bg-[#FFFFFF40] p-5">
              <span className="text-3xl font-bold md:text-4xl">{formatTime(timeLeft.days)}</span>
          ...
          {showHours && (
            <div className="flex flex-col items-center rounded-md border-2 border-white bg-[#FFFFFF40] p-5">
              <span className="text-3xl font-bold md:text-4xl">{formatTime(timeLeft.hours)}</span>
          ...
          {showMinutes && (
            <div className="flex flex-col items-center rounded-md border-2 border-white bg-[#FFFFFF40] p-5">
              <span className="text-3xl font-bold md:text-4xl">{formatTime(timeLeft.minutes)}</span>
          ...
          {showSeconds && (
            <div className="flex flex-col items-center rounded-md border-2 border-white bg-[#FFFFFF40] p-5">
              <span className="text-3xl font-bold md:text-4xl">{formatTime(timeLeft.seconds)}</span>
      ...
      <div className="absolute left-2 top-2 hidden overflow-hidden xl:block">
        <Image width={116} height={118} src={"/icons/box-2.png"} alt={"icon"} className="object-cover" />
      </div>
