    ...
    <section className="min-h-[1149px] bg-accent py-[70px]">
      <Wrapper>
        <header className="mx-auto mb-[63px] min-h-[129px] max-w-[650px] text-center">
          <h2 className="mb-[22px] text-[24px] lg:text-[35px]">Meet the Team</h2>
          <p>
            Our team comprises a dynamic group of young and vibrant professionals who possess an unwavering commitment
            to go the extra mile in delivering exceptional service.
          </p>
        </header>
