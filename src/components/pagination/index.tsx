      ...
      <PaginationContent>
        ...
        {Array.from({ length: totalPages }, (_, index) => index + 1).map((page) => (
          <PaginationItem key={page}>
            <a
              href="#"
              className={clsx("rounded px-2 py-1", currentPage === page ? "bg-blue-900 text-white" : "text-gray-500")}
        ...
        <PaginationItem>
          {currentPage < totalPages && (
            <PaginationNext href="#" onClick={(event) => handlePageChange(event, currentPage + 1)} size={undefined} />
          )}
        </PaginationItem>
      </PaginationContent>
    </Pagination>
