...
function CardTitle({ className, ...properties }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("font-semibold leading-none", className)} {...properties} />;
}
...
function CardFooter({ className, ...properties }: React.ComponentProps<"div">) {
  return (
    <div data-slot="card-footer" className={cn("[.border-t]:pt-6 flex items-center px-6", className)} {...properties} />
  );
}
